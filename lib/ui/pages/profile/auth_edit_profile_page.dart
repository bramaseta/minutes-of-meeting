...
class AuthEditProfile extends StatelessWidget {
  AuthEditProfile({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<AuthEPController>(
        ...
        builder: (_) {
          return Scaffold(
            ...
            body: Stack(
              children: [
                Column(children: const [SizedBox(height: 40), Center(child: Logo())]),
                Container(
                        ...
                        children: [
                          ...
                          PRO(context).selectedCategory == "English" 
                            ...
                            : (PRO(context).selectedCategory == "Chinese"
                                ? "邮箱"
                                : "Email"),
                           controllerField: _controllerPage.emailField, keyboardType: TextInputType.emailAddress),
                          ...
                          : (PRO(context).selectedCategory == "Chinese"
                              ? "手机号码"
                              : "Nomor Telepon"),
                          controllerField: _controllerPage.phoneField, keyboardType: TextInputType.number),
                          const SizedBox(height: 20),
                          // BUTTON
                          SizedBox(
                            width: double.infinity,
                            child: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  ...
                                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(16.0))),
                                ),
                                child: Text(
                                  PRO(context).selectedCategory == "English" 
                                  ? "Save" 
